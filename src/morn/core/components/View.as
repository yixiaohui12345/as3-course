...
package morn.core.components {
	import morn.core.components.law.*;
	...
	public class View extends Box {
		...
		protected static var uiClassMap:Object = {"EMovie":EMovie,"EText":EText,"EImage":EImage,"EPage":EPage,"Box": Box, "Button": Button, "CheckBox": CheckBox, "Clip": Clip,"ColorPicker":ColorPicker, "ComboBox": ComboBox, "Component": Component, "Container": Container, "FrameClip": FrameClip, "HScrollBar": HScrollBar, "HSlider": HSlider, "Image": Image, "Label": Label, "LinkButton": LinkButton, "List": List, "Panel": Panel, "ProgressBar": ProgressBar, "RadioButton": RadioButton, "RadioGroup": RadioGroup, "ScrollBar": ScrollBar, "Slider": Slider, "Tab": Tab, "TextArea": TextArea, "TextInput": TextInput, "View": View, "ViewStack": ViewStack, "VScrollBar": VScrollBar, "VSlider": VSlider, "HBox": HBox, "VBox": VBox, "Tree": Tree};
