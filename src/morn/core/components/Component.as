...
package morn.core.components {
	...
	public class Component extends Sprite implements IComponent {
		...
		protected var _removeHandler:Handler = null;
		
		public function Component() {
			mouseChildren =false //tabEnabled = tabChildren = false;
			preinitialize();
			createChildren();
			initialize();
		}
		...
		public function get removeHandler():Handler 
		{
			return _removeHandler;
		}
		
		public function set removeHandler(value:Handler):void 
		{
