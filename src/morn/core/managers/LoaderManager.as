...
package morn.core.managers {
	...
	public class LoaderManager extends EventDispatcher {
		...
		public function loadMovie(url:String, complete:Handler = null, progress:Handler = null, error:Handler = null, isCacheContent:Boolean = true):void
		{
			load(url, ResLoader.MOVIE, complete, progress, error, isCacheContent);
		}
